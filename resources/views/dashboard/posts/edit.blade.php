                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="/dashboard/posts/{{ $post->slug }}" method="POST"
                                    ...
                                    <input type="hidden" name="oldImage" value="{{ $post->image_thumbnail }}">
                                    @if ($post->image_thumbnail)
                                        <img src="{{ asset('storage/' . $post->image_thumbnail) }}"
                                            class="gambar-preview img-fluid mb-3 col-sm-5">
                                    @else
                                    ...
                                    {{-- KONDISI JIKA GAMBAR-1 KOSONG --}}
                                    <input type="hidden" name="oldImage" value="{{ $post->image_post_satu }}">
                                    @if ($post->image_post_satu)
                                        <img src="{{ asset('storage/' . $post->image_post_satu) }}"
                                            class="gambar-preview img-fluid mb-3 col-sm-5">
                                    @else
                                        <img class="gambar-preview img-fluid mb-3 col-sm-5">
                                    @endif
                                    ...
                                    {{-- KONDISI JIKA GAMBAR-2 KOSONG --}}
                                    <input type="hidden" name="oldImage" value="{{ $post->image_post_dua }}">
                                    @if ($post->image_post_dua)
                                        <img src="{{ asset('storage/' . $post->image_post_dua) }}"
                                            class="gambar-preview img-fluid mb-3 col-sm-5">
                                    @else
                                        <img class="gambar-preview img-fluid mb-3 col-sm-5">
                                    @endif
                                    ...
                                    {{-- KONDISI JIKA GAMBAR-3 KOSONG --}}
                                    <input type="hidden" name="oldImage" value="{{ $post->image_post_tiga }}">
                                    @if ($post->image_post_tiga)
                                        <img src="{{ asset('storage/' . $post->image_post_tiga) }}"
                                            class="gambar-preview img-fluid mb-3 col-sm-5">
                                    @else
                                        <img class="gambar-preview img-fluid mb-3 col-sm-5">
                                    @endif
